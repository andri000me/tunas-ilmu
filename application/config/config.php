...
$config['database_name']	= 'tunas_ilmu';
...
$config['web_title']		= "Pendaftaran Santri Tunas Ilmu";
$config['web_footer']		= $config['web_title']." &copy; <?php echo date('Y');?>. Pondok Pesantren Tunas Ilmu";
...
|
*/
$config['encryption_key'] = 'lafaram98';
